...
final class UserWasPromoted extends \Prooph\EventSourcing\AggregateChanged
{
    public const MESSAGE_NAME = 'AulaSoftwareLibre\Iam\Domain\User\Event\UserWasPromoted';
    ...
    public static function with(\AulaSoftwareLibre\Iam\Domain\User\Model\UserId $userId, \AulaSoftwareLibre\Iam\Domain\Role\Model\RoleId $roleId): UserWasPromoted
    {
