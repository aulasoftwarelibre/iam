...
final class DemoteUser extends \Prooph\Common\Messaging\Command
{
    use \Prooph\Common\Messaging\PayloadTrait;

    public const MESSAGE_NAME = 'AulaSoftwareLibre\Iam\Application\User\Command\DemoteUser';
    ...
    public static function with(\AulaSoftwareLibre\Iam\Domain\User\Model\UserId $userId, \AulaSoftwareLibre\Iam\Domain\Role\Model\RoleId $roleId): DemoteUser
    {
        return new self([
